  ...
  <body class="nav-md">
			...
			<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="formCreate" action="/travel/admin/blog/create" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea required="required" class="form-control" name="summary"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a href="/travel/admin/blog" class="btn btn-primary" type="button">Cancel</a>
    ...
    <script>
	    $('#formCreate').on('submit', function() {
		  $('#formCreate input[name="content"]').val($('#editor-one').html());
		});
    </script>
  </body>
</html>