...
<html lang="en">
  <head>
    ...
    <title>Create Service Panel || Admin</title>
			...
			<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="formCreate" action="<%= request.getAttribute("sitePath") %>/admin/service-panel/create" method="post" data-parsley-validate class="form-horizontal form-label-left">
