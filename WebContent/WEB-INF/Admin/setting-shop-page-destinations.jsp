            ...
            <div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="formShopPageDestinationsSetting" action="<%= request.getAttribute("sitePath") %>/admin/setting/shop-page-destinations" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="input_head_bg" name="head_bg" value="<%= shopPageDestinationsSetting.data.get("head_bg") %>" required="required" class="form-control">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="foritem_head_h1" value="<%= shopPageDestinationsSetting.forItem.get("head_h1") %>" required="required" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="foritem_head_h2" value="<%= shopPageDestinationsSetting.forItem.get("head_h2") %>" required="required" class="form-control">
                        </div>
                      </div>
