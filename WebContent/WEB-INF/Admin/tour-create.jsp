                  ...
                  <div class="x_content">
                    ...
                    <form id="formCreate" action="<%= request.getAttribute("sitePath") %>/admin/tour/create" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="editorInputDetailText" name="detail_text" class="form-control" readonly required="required"></textarea>
                        </div>
                        <diV class="col-md-3 col-sm-3 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="editorInputExpectText" name="expect_text" class="form-control" readonly required="required"></textarea>
                        </div>
                        <diV class="col-md-3 col-sm-3 col-xs-12">
