        ...
        <div class="right_col" role="main">
			...
			<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit blog <small><%= blog.getTitle() %></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="formEdit" action="<%= request.getAttribute("sitePath") %>/admin/blog/edit" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="inputThumbnail150x150" value="<%= blog.getThumbnail150x150() %>" name="thumbnail150x150" required="required" class="form-control">
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" step="1" required="required" name="view_count" value="<%= blog.getViewCount() %>" class="form-control">
                        </div>
                      </div>
