                    ...
                    <form id="formInfosSetting" action="<%= request.getAttribute("sitePath") %>/admin/setting" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <button data-input="#input_shop_logo" type="button" class="btnUploadImage btn btn-primary" data-toggle="modal" data-target="#modalUploadImage">Upload</button>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" name="shop_media_fb" value="<%= infosSetting.data.get("shop_media_fb") %>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" name="shop_media_yt" value="<%= infosSetting.data.get("shop_media_yt") %>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" name="shop_media_ig" value="<%= infosSetting.data.get("shop_media_ig") %>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" required="required" name="shop_media_tw" value="<%= infosSetting.data.get("shop_media_tw") %>" class="form-control">
                        </div>
                      </div>
