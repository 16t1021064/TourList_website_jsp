        ...
        <div class="right_col" role="main">
			...
			<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit banner <small><%= banner.getTextH1() %></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="formEdit" action="<%= request.getAttribute("sitePath") %>/admin/banner/edit" method="post" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="text_h1" value="<%= banner.getTextH1() %>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="text_h2" value="<%= banner.getTextH2() %>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="text_h3" value="<%= banner.getTextH3() %>" class="form-control">
                        </div>
                      </div>
                      <div class="form-group">
